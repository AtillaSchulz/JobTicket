 ...
 * juni 2012
 * <p>
 * Modelklasse f�r die Angestellten
 * </p>
 * 
...
public class AngestellteModel implements Serializable {
	...
	/**
	 * Trigger f�r das Anzeigen der Angestelltentabelle wird im Hauptlayout
	 * nicht verwendet
	 */
	...
	/**
	 * Autokomplete f�r die Angestelltenbezeichnung
	 * 
	 * @param str
	...
	/**
	 * Autokomplete f�r den Angestelltennamen
	 * 
	 * @param str
	 *            die im Layout eingegebenen Buchstaben
	 * @return eine Liste der �bereinstimmenden Eintr�ge aus der Datenbank
	...
	/**
	 * Erstellt fals m�glich einen Angestellten �berpr�ft ob die Pflichtfelder
	 * ausgef�llt wurden und gibt gegebenfals eine Fehlermeldung zur�ck
	 */
	...
	/**
	 * Trigger f�r das Darstellen der AngestelltenMinusButtons
	 */
